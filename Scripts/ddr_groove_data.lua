...
-------------------------------------------------- DOUBLE --------------------------------------------------
	StepsType_Dance_Double= {
		...
		["MAX.(period)"] = {
			Easy = {57, 50, 12, 5, 0}, 
			Medium = {77, 76, 21, 4, 5}, 
			Hard = {136, 101, 10, 7, 40}, 
			Challenge = {153, 101, 56, 8, 49}, 
		}, 
		["EGOISM 440"] = {
			Easy = {60, 70, 7, 11, 7}, 
			Medium = {86, 106, 10, 14, 32}, 
			Hard = {152, 135, 182, 14, 122}, 
