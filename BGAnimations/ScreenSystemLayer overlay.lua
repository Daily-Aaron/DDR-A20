local function CreditsText()
	local text = LoadFont("_futura lt medium 24px") .. {
		InitCommand=cmd(zoom,0.64;x,SCREEN_CENTER_X;y,SCREEN_BOTTOM-10.5;strokecolor,color("0.3,0.3,0.3,1");playcommand,"Refresh");
...
local function NetworkText()
	local text = LoadFont("_futura lt medium 24px") .. {
		InitCommand=function (self)
			...
			self:settext("-----");
			self:x(SCREEN_CENTER_X-265);
			self:y(SCREEN_BOTTOM-10.5);
