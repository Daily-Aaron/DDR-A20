...
return Def.ActorFrame{
    ...
    Def.Sprite{
        ...
        OnCommand=function(s) s:setsize(442,31):y(-1)
    ...
    Def.Sprite{
        Name="LifeFrame"..pn,
        InitCommand=function(s) s:xy(pn==PLAYER_1 and 0 or 0,4):rotationy(pn==PLAYER_2 and 180 or 0) end,
        BeginCommand=function(self)
            if GAMESTATE:PlayerIsUsingModifier(pn,'battery') or GAMESTATE:GetPlayMode() == 'PlayMode_Oni' then
            self:Load(THEME:GetPathB("ScreenGameplay","decorations/lifeframe/"..version..ddrgame.."gauge0000_frame_4life.png"))  
          else
              self:Load(THEME:GetPathB("ScreenGameplay","decorations/lifeframe/"..version..ddrgame.."gauge0000_frame_normal.png"))
          end;
        end
    }
}