...
--Player 1 Dead
t[#t+1] = LoadActor("jx3hd_gover0")..{
	InitCommand=cmd(player,"PlayerNumber_P1";visible,false;x,265;y,SCREEN_CENTER_Y;bob;effectperiod,0.533;effectmagnitude,0,5,0;rotationz,-5);
...
--Player 2 Dead
t[#t+1] = LoadActor("jx3hd_gover1")..{
	InitCommand=cmd(player,"PlayerNumber_P2";visible,false;x,SCREEN_RIGHT-265;y,SCREEN_CENTER_Y;bob;effectperiod,0.533;effectmagnitude,0,5,0;rotationz,-5);
	HealthStateChangedMessageCommand=function(self, param)
