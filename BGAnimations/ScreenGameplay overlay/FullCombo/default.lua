		...
		OffCommand=function(self)
			if (pss:FullCombo() or pss:FullComboOfScore('TapNoteScore_W4')) then
				if GAMESTATE:PlayerIsUsingModifier(pn,'reverse') then
					...
					self:diffusealpha(1);
					self:zoomx(0);
					self:linear(1.2*0.06);
					self:zoomx(4);
					self:zoomy(1);
					self:linear(1.2*0.08);
					self:zoomx(1);
					self:addy(-120);
					self:linear(1.2*0.28);
					self:addy(-720);
				else
					self:y(SCREEN_CENTER_Y-160);
					self:diffusealpha(1);
	...
	LoadActor( "Star" ) .. {
		InitCommand=function(self)
			...
			if GAMESTATE:PlayerIsUsingModifier(pn,'reverse') then
				...
				self:y(SCREEN_CENTER_Y-65-21.2);
			end;
		end;
		OffCommand=function(self)
			if (pss:FullCombo() or pss:FullComboOfScore('TapNoteScore_W4')) then
	...
	LoadActor( "Fullcombo01" ) .. {
		...
		OffCommand=function(self)
			if (pss:FullCombo() or pss:FullComboOfScore('TapNoteScore_W4')) then
				...
				self:zoomx(2);
				self:zoomy(0);
				self:linear(1.2*0.04);
				self:zoomy(2);
				self:rotationz(0);
				self:linear(1.2*0.3*1.2);
				self:zoom(1.2);
				self:rotationz(90);
				self:linear(1.2*0.15);
				self:zoomy(0.3);
	...
	LoadActor( "Fullcombo02" ) .. {
		...
		OffCommand=function(self)
			if (pss:FullCombo() or pss:FullComboOfScore('TapNoteScore_W4')) then
				...
				self:zoomx(4);
				self:zoomy(0);
				self:linear(1.2*0.06*1.5);
				self:zoomy(4);
				self:rotationz(0);
				self:linear(1.2*0.3*1.5);
				self:zoom(1.25);
				self:rotationz(-90);
				self:linear(1.2*0.15*1.5);
				self:zoomy(0);
				self:zoomx(0.5);
				self:diffusealpha(0);
			end;
	...
	Def.Sprite{
		OffCommand=function(self)
			if pss:FullComboOfScore('TapNoteScore_W1') then
				self:Load(THEME:GetPathB("ScreenGameplay","overlay/FullCombo/"..ddrgame.."FCM.png"));
				self:diffusealpha(0);
				self:rotationz(0);
				self:sleep(0.6);
				self:diffusealpha(1);
				self:zoomy(0);
				self:linear(1.2*0.06);
				self:zoom(TextZoom()*1.24/1.5);
				self:linear(1.2*0.3);
				self:zoom(TextZoom()*1.15*1.24/1.5);
				self:linear(1.2*0.03);
				self:diffusealpha(0.66);
				self:zoomx(TextZoom()*1.165*1.24/1.5);
				self:linear(1.4*0.06);
				self:zoomy(0);
				self:zoomx(TextZoom()*1.195*1.24/1.5);
				self:diffusealpha(0);
			elseif pss:FullComboOfScore('TapNoteScore_W2') then
				self:Load(THEME:GetPathB("ScreenGameplay","overlay/FullCombo/"..ddrgame.."FCP.png"));
				self:diffusealpha(0);
				self:rotationz(0);
				self:sleep(0.6);
				self:diffusealpha(1);
				self:zoomy(0);
				self:linear(1.2*0.06);
				self:zoom(TextZoom()*1.11/1.5);
				self:linear(1.2*0.3);
				self:zoom(TextZoom()*1.15*1.11/1.5);
				self:linear(1.2*0.03);
				self:diffusealpha(0.66);
				self:zoomx(TextZoom()*1.165*1.11/1.5);
				self:linear(1.4*0.06);
				self:zoomy(0);
				self:zoomx(TextZoom()*1.195*1.11/1.5);
				self:diffusealpha(0);
			elseif pss:FullComboOfScore('TapNoteScore_W3') then
				self:Load(THEME:GetPathB("ScreenGameplay","overlay/FullCombo/"..ddrgame.."FCGr.png"));
				self:diffusealpha(0);
				self:rotationz(0);
				self:sleep(0.6);
				self:diffusealpha(1);
			...
			elseif pss:FullComboOfScore('TapNoteScore_W4') then
				self:Load(THEME:GetPathB("ScreenGameplay","overlay/FullCombo/"..ddrgame.."FCGo.png"));
				self:diffusealpha(0);
				self:rotationz(0);
				self:sleep(0.6);
				self:diffusealpha(1);
