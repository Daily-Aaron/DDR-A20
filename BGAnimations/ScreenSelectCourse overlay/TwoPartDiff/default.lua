		...
		f[i] = Def.ActorFrame{
			...
			Def.ActorFrame{
				...
				Def.Sprite{
					...
					InitCommand=function(s) s:diffusealpha(0):rotationy(-90):zoom(1.2):x(0) end,
					OutCommand=function(s)
						if i == selection[player] then
                    ...
                    Def.Sprite{
					Texture=ddrgame.."/difficulty_pleasewait.png",
				...
				Def.Sprite{
					Texture=ddrgame.."/difficulty_pleasewait_dot.png",
...
local t = Def.ActorFrame{
	...
	genScrollerFrame(PLAYER_1)..{
		...
		InitCommand=function(self)
			...
			self:xy(SCREEN_LEFT+460,SCREEN_CENTER_Y-36);
		end;
	};
	genScrollerFrame(PLAYER_2)..{
		...
		InitCommand=function(self)
			...
			self:xy(SCREEN_RIGHT-460,SCREEN_CENTER_Y-36)
		end;
	};
