...
local scrollbar_lane_base = LoadActor(ddrgame.."scrollbar_lane_base");
...
return Def.ActorFrame{
  ...
  Def.ActorFrame{
    ...
    Def.ActorFrame{
      InitCommand=function(s) s:y(SCREEN_TOP-28):diffusealpha(0.5) end,
      up_module_up_line..{
    ...
    Def.ActorFrame{
      InitCommand=function(s) s:y(SCREEN_TOP+2):diffusealpha(0.5) end,
    ...
    Def.ActorFrame{
      InitCommand=function(s) s:y(SCREEN_TOP+72):diffusealpha(0.5) end,
  ...
  Def.ActorFrame{
    Name="PanelBackers";
    Def.ActorFrame{
      InitCommand=function(s) s:y(SCREEN_BOTTOM+4):diffusealpha(0.7) end,
      radarbacker..{
	...
	Def.ActorFrame{
      InitCommand=function(s) s:y(SCREEN_BOTTOM-14):diffusealpha(0.7) end,
      rival_window_square..{
	...
	Def.ActorFrame{
      InitCommand=function(s) s:halign(0):y(_screen.cy-3):x(SCREEN_RIGHT-288) end,
      scrollbar_lane_base;
	};
  };
