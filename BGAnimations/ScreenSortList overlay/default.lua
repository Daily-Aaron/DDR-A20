		...
		Def.ActorFrame{
			...
			LoadActor(THEME:GetPathG("","_shared/"..ddrgame.."cursor"))..{
				InitCommand=function(s) s:x(-90)
					s:bounce():effectclock("0.1"):effectperiod(1):effectmagnitude(-10,0,0):effectoffset(0.5):zoom(0.75)
				end,
			},
			LoadActor(THEME:GetPathG("","_shared/"..ddrgame.."cursor"))..{
				InitCommand=function(s) s:x(90):zoomx(-0.75):zoomy(0.75)
					s:bounce():effectclock("0.1"):effectperiod(1):effectmagnitude(10,0,0):effectoffset(0.5)
				end,
			},
		},
		Def.BitmapText{
