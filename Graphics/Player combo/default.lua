...
local t = Def.ActorFrame {
	Def.ActorFrame {
		...
		LoadFont(ddrgame.."combo", "good") .. {
			Name="NumberNormal";
			OnCommand = THEME:GetMetric("Combo", "NumberOnCommand");
		};
		LoadActor(ddrgame.."dance_combo0000_marvelous_combo") .. {
			Name="LabelW1";
			OnCommand = THEME:GetMetric("Combo", "LabelOnCommand");
		};
		LoadActor(ddrgame.."dance_combo0000_perfect_combo") .. {
			Name="LabelW2";
			OnCommand = THEME:GetMetric("Combo", "LabelOnCommand");
		};
		LoadActor(ddrgame.."dance_combo0000_great_combo") .. {
			Name="LabelW3";
			OnCommand = THEME:GetMetric("Combo", "LabelOnCommand");
		};
		LoadActor(ddrgame.."dance_combo0000_good_combo") .. {
			Name="LabelNormal";
			OnCommand = THEME:GetMetric("Combo", "LabelOnCommand");
		};
	};
